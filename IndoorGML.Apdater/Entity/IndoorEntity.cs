...
namespace IndoorGML.Adapter.Entity
{
    public class IndoorEntity
    {
        ...
        public CellSpaceGeometry ConvertGeo(InDoorPolyline roomBoundary,string id,float Elevation,float floorHeight)
        {
        ...
        public IEnumerable<SurfaceMember> ConvertPolylineToSurfaces(InDoorPolyline polyline,float Elevation,float floorHeight)
        {
        ...
        public virtual CellSpaceMember ToCellSpaceMember()
        {
            ...
            member.GeneralSpace = new GeneralSpace();
